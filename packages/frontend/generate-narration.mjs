...
const SCENES = [
  ...
  { file: "s2.mp3",  text: "Introducing zcoin.bio. 21 million coins. DNA encoded. Unforgeable. No blockchain. No KYC. No GPU needed. Works offline. The living cryptocurrency." },
  ...
  { file: "s5.mp3",  text: "Meet Zee-Bio-Coin. A cryptocurrency built on biology, not bureaucracy. Six thousand DNA bases per wallet. 180 bases per coin gene. 504 bits of combined security. 21 million maximum supply. And zero KYC required." },
  ...
  { file: "s13.mp3", text: "Accept Zee-Bio-Coin payments on any website. Like PayPal, Stripe, or Revolut — but powered by DNA. Customer clicks Pay with Zee-Bio-Coin. A wallet popup opens. They confirm with their private key. The mRNA transfer is sent. And it's verified instantly. No credit card processor. No 3 percent fee. No chargebacks. Just biology." },
  { file: "s14.mp3", text: "Integration takes five lines of code. Import the Zee-Bio-Coin gateway SDK. Create a new pay instance pointed at zcoin.bio. Call checkout with an amount and label. That's it. Works on React, Vue, Svelte, WordPress, Shopify — anything. One script tag. One function call. The wallet popup handles the rest. Instant settlement." },
  { file: "s15.mp3", text: "Don't want to mine? Buy coins directly from miners on the Zee-Bio-Coin marketplace. Sell digital art. Sell game credits. Sell premium access. Peer to peer. No middleman takes a cut." },
  { file: "s16.mp3", text: "Who is Zee-Bio-Coin for? Miners: open a browser tab and earn coins with zero hardware investment. Merchants: accept DNA payments with five lines of code and zero fees. Developers: build on our SDK — games, marketplaces, tipping, anything with value. And everyone else: no bank needed, no ID needed. Send value to anyone, anywhere, anytime." },
  { file: "s17.mp3", text: "The Zee-Bio-Coin economy. Earn by mining while your browser tab runs in the background. Own your keys — your private key never leaves your device. Instant and free: no gas fees, no confirmation wait. Biologically unique: every coin has DNA proving its origin. Works offline. And it's fully open source." },
  ...
  { file: "s19.mp3", text: "Join the organism. 21 million hard cap. Four security layers. Zero blockchain. Zero KYC. Infinite coin validity. No ICO. No pre-mine. No venture capital. Open source. Live right now. Start mining at zcoin.bio." },
  { file: "s20.mp3", text: "Bitcoin reimagined the economy. Zee-Bio-Coin reimagines it through the lens of life itself. No blockchain. No KYC. No middleman. No fees. No limits. 21 million coins. Four layers of defense. Telomere-enforced scarcity. Mine for free — in your browser. zcoin.bio." },
];
